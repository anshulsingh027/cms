  ...
  <body>
   ...
   <div class="jumbotron">
       <div class="container">
           <div id="details" class="animated slideInLeft">
               ...
               <p>here you can put your own tagline</p>
           </div>
       </div>
   ...
   <section><div class="container">
      ...
      <div class="post">
                    ...
                    <a href="img/<?php echo $image;?>"> <img src="img/<?php echo $image;?>" alt="Post image" width="100%"></a>
                    <div class="desc">
                      <?php echo $post_data;?>
                    </div>
               ...
               if(isset($_POST['submit'])){
                   ...
                   if(empty($cs_name)or empty($cs_email)or empty($cs_comment)){
                    $error_msg="All (*) fields are Required " ;  
                       ...
                       $cs_query="INSERT INTO comments (`id`, `date`, `name`, `username`, `post_id`, `email`, `website`, `image`, `comment`, `status`) VALUES ('NULL', '$cs_date', '$cs_name', 'user', '$post_id', '$cs_email', '$cs_website', 'user4.jpg', '$cs_comment', 'pending')";
                        ...
                        <div class="col-xs-12">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="full-name" name="email" value="<?php if(isset($cs_email)){echo $cs_email;}?>" class="form-control" placeholder="Email Address">
                                </div>
                                <div class="form-group">
                                    <label for="website">Website:</label>
                                    <input type="text" id="website" name="website" class="form-control" value="<?php if(isset($cs_website)){echo $cs_website;}?>" placeholder="Website Url">
                                </div>
                                <div class="form-group">
                                    <label for="comment">Comment:*</label>
                                    <textarea  id="comment" cols="30" name="comment" rows="10" placeholder="Your Comments" class="form-control"><?php if(isset($cs_comment)){echo $cs_comment;} ?></textarea>        
                                </div>
