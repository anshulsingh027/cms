              ...
              <div class="container-fluid body-section">
                <div class="row">
                  ...
                  <div class="col-md-9">
                    ...
                    <div class="row tag-boxes"><!--tag-boxes class is user defined-->
                      <div class="col-md-6 col-lg-3">
                        <div class="panel panel-primary">
                          <div class="panel-heading">
                            <div class="row">
                              <div class="col-xs-3">
                                <i class="fa fa-comments fa-5x"></i><!--For larger we use fa-5x-->
                              </div>
                            <div class="col-xs-9">
                              <div class="text-right huge"><?php echo $com_rows;?></div><!--huge is a user defined class.used so that size of 11 is bigger-->
                          ...
                          <a href="comments.php">
                            <div class="panel-footer">
                              ...
                              <div class="clearfix"></div><!--required to fix the issue that right arrow circle was coming out of highlighted area-->
                            </div>
                          </a>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 col-lg-3">
                        <div class="panel panel-red">
                          <div class="panel-heading">
                            <div class="row">
                              <div class="col-xs-3">
                                <i class="fa fa-file-text fa-5x"></i><!--For larger we use fa-5x-->
                              </div>
                            <div class="col-xs-9">
                              <div class="text-right huge"><?php echo $post_rows;?></div><!--huge is a user defined class.used so that size of 11 is bigger-->
                      ...
                      <div class="col-md-6 col-lg-3"><!--for larger screen 4 at a time, for medium screen 2 at a time-->
                        <div class="panel panel-yellow">
                          <div class="panel-heading">
                            <div class="row">
                              <div class="col-xs-3">
                                <i class="fa fa-users fa-5x"></i><!--For larger we use fa-5x-->
                              </div>
                            <div class="col-xs-9">
                              <div class="text-right huge"><?php echo $user_rows;?></div><!--huge is a user defined class.used so that size of 11 is bigger-->
                      ...
                      <div class="col-md-6 col-lg-3">
                        <div class="panel panel-green">
                          <div class="panel-heading">
                            <div class="row">
                              <div class="col-xs-3">
                                <i class="fa fa-folder-open fa-5x"></i><!--For larger we use fa-5x-->
                              </div>
                            <div class="col-xs-9">
                              <div class="text-right huge"><?php echo $cat_rows;?></div><!--huge is a user defined class.used so that size of 11 is bigger-->
