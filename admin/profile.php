...
?>
  ...
  <body id="profile">
    <div id="wrapper"><!--So that when any content is deleted from bosy,footer sticks to the bottom of page otherwise it would move up-->
              ...
              <div class="container-fluid body-section">
                <div class="row">
                  ...
                  <div class="col-md-9">
                    ...
                    <div class="row">
                      <div class="col-xs-12">
                        <center><img src="img/<?php echo $image;?>" alt="image" width="200px" class="img-circle img-thumbnail" id="profile-image">
                        </center><hr>
