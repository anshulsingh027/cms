  ...
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php">
          <div class="col-xs-3"><img src="img/logo2.png" alt="Logo" width="30px"></div>
          <div class="col-xs-9">Ansul</div>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
           ...
           <?php
              ...
              if(mysqli_num_rows($run) > 0){
                  while($row = mysqli_fetch_array($run)){
                   ...
                   echo "<li><a href='#'>Ni Category Yet</a></li>";
               }   
        ...
        <li><a href="Contact-us.php"><i class="fa fa-phone-square" aria-hidden="true"></i> Contact Us</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>